#+TITLE: Viaje con Inteligencia - Resumen Ejecutivo
#+AUTHOR: M. Castillo
#+EMAIL: mybloggingnotes@gmail.com
#+STARTUP: content
#+DESCRIPTION: Resumen Ejecutivo del Proyecto Viaje con Inteligencia
#+LATEX_CLASS: article

* [[./logo.png]]

*Viaje con Inteligencia* es la primera plataforma en español que agrega información oficial de riesgos de viaje de 100 países, combinando datos del MAEC español, inteligencia artificial y fuentes OSINT en tiempo real.
...
**El Problema**
Los viajeros españoles carecen de una fuente actualizada, gratuita y fiable sobre riesgos de viaje por país. La información oficial del MAEC está dispersa y no hay herramientas que combinen riesgos con datos turísticos, meteorológicos y de IA.

**La Solución**
Una plataforma web + PWA que integra:
...
Este documento resume la plataforma *Viaje con Inteligencia*.
Para documentación técnica detallada, ver [[./TECHNICAL_DOC.org]].
