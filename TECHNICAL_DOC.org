#+TITLE: Viaje con Inteligencia - Documentación Técnica
#+AUTHOR: M. Castillo
...
#+begin_src plantuml
@startuml :file arquitectura.png
!theme plain
...
|----------|------------|-------|
| SUPABASE_URL | Proyecto Supabase | All |
| SUPABASE_ANON_KEY | Clave pública | All |
| SERVICE_ROLE_KEY | Clave admin | Production |
| RESEND_API_KEY | Email | Production |
| GROQ_API_KEY | IA | Production |
| CRON_SECRET | Auth cron | Production |
| TELEGRAM_BOT_TOKEN | Bot | Production |
| TELEGRAM_CHANNEL_ID | Canal | Production |
| STRIPE_SECRET_KEY | Pagos | Production |

** Scripts de Backup
- =scripts/backup-env.sh= - Crear backup
- =scripts/restore-env.sh= - Restaurar
