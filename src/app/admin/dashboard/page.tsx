  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        {/* AI Assistant */}
        <section className="bg-slate-800 rounded-2xl border border-blue-500/30 p-6">
          <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
            <Bot className="w-5 h-5 text-blue-400" />
            Asistente IA
          </h2>
          <p className="text-slate-400 text-sm mb-4">Análisis SEO, generación de posts, meta tags y consultas libres con Groq. Sin escribir código.</p>
          <div className="flex gap-3">
        ...
        <section className="bg-slate-800 rounded-2xl border border-slate-700 p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Delta semanal de tone_score por país. Países con mayor caída de sentimiento vs semana anterior.</p>
          <div className="flex gap-3">
            <a href="/admin/sentiment-trends" className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600/20 border border-emerald-500/30 text-emerald-400 rounded-lg hover:bg-emerald-600/30 transition-colors text-sm font-medium">
              Ver tendencias <TrendingUp className="w-4 h-4" />
            </a>
          </div>
        </section>
        ...
        <section className="bg-slate-800 rounded-2xl border border-slate-700 p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              { label: 'Análisis de destinos', desc: 'Destinos agrupados por IA', href: '/clustering', icon: '🤖', status: 'existe' },
              { label: 'Evolución IA', desc: 'MAE, desviaciones, histórico', href: '/admin/ml', icon: '🧠', status: 'existe' },
              ...
              { label: 'Análisis Petróleo IA', desc: 'Predicciones de crudo', href: '/petroleo', icon: '🛢️', status: 'existe' },
        ...
        <section className="bg-slate-800 rounded-2xl border border-slate-700 p-6">
          ...
          <p className="text-slate-400 text-sm mb-4">Simula Googlebot en URLs del sitemap, verifica indexabilidad, caché de Google y actividad de crawlers en Cloudflare.</p>
          <div className="flex gap-3">
            <a href="/admin/seo-check" className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600/20 border border-blue-500/30 text-blue-400 rounded-lg hover:bg-blue-600/30 transition-colors text-sm font-medium">
              Analizar ahora <Search className="w-4 h-4" />
            </a>
          </div>
        </section>
