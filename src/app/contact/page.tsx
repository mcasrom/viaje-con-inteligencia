    ...
    <div className="min-h-screen bg-slate-900">
      <header className="bg-slate-800 border-b border-slate-700">
        <div className="max-w-2xl mx-auto px-6 py-4">
          <Link href="/relojes" className="flex items-center gap-2 text-slate-400 hover:text-white transition-colors">
            <ArrowLeft className="w-5 h-5" />
            <span>Volver a relojes</span>
          </Link>
        </div>
      </header>
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400">
            ¿Falta tu ciudad favorita? Cuéntanos y la añadiremos a los relojes mundiales.
          </p>
        </div>
        ...
        {submitted ? (
          <div className="bg-green-500/20 border border-green-500/50 rounded-2xl p-8 text-center">
            ...
            <Link href="/relojes" className="text-blue-400 hover:text-blue-300">
              ← Volver a relojes mundiales
            </Link>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Me gustaría añadir Lima, Perú y Bogotá, Colombia..."
              />
            </div>
        ...
        <div className="mt-12 grid md:grid-cols-2 gap-4">
          ...
          <a
            href="https://t.me/mybloggingnotes"
            target="_blank"
          ...
          >
            ...
            <div>
              ...
              <div className="text-sm text-slate-400">@mybloggingnotes</div>
            </div>
          </a>
        </div>
      </main>
