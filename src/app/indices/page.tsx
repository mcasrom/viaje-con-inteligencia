...
const PAIS_COORDS: Record<string, [number, number]> = {
  ...
  JP: [36.2048, 138.2529], CN: [35.8617, 104.1954], KR: [35.9078, 127.7669],
  ...
  PK: [30.3753, 69.3451], BD: [23.6850, 90.3563], NP: [28.3949, 84.1240], LK: [7.8731, 80.7714],
  MM: [21.9162, 95.9560], KH: [12.5657, 104.9910], LA: [19.8563, 102.4955], DO: [18.7357, -70.1626],
  HN: [15.2000, -86.2419], SV: [13.7942, -88.9145], NI: [12.8654, -85.2072], UY: [-32.5228, -55.7652],
  PY: [-23.4425, -58.4438], BO: [-16.2902, -63.5889], PE: [-9.1900, -75.0152], EC: [-1.8312, -78.1834],
  VE: [6.4238, -66.5897], BH: [26.0667, 50.5577], KW: [29.3117, 47.4818], QA: [25.3548, 51.1839],
  SA: [23.8859, 45.0796], AE: [23.4241, 53.8478], IL: [31.0461, 34.8516], JO: [30.5852, 36.2384],
