...
export const metadata: Metadata = {
  ...
  description: 'Crea itinerarios personalizados con inteligencia artificial. Destino, perfil de viajero, tipo de viaje, presupuesto, intereses y radio máximo. Tu viaje perfecto en minutos.',
