    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <div className="flex flex-col items-center justify-center pt-4 pb-4 px-4">
        <div className="w-full max-w-2xl mx-auto">
          ...
          <p className="text-slate-300 text-base md:text-lg text-center mb-4">
            Riesgo pais en tiempo real - alertas OSINT - fuentes oficiales
          </p>
          ...
          <section className="w-full mt-10 mb-6 text-center">
            ...
            <div className="flex flex-col gap-2 text-sm">
              <a href="https://tools.viajeinteligencia.com" className="text-blue-400 hover:text-blue-300">
                Tools - Travel Intelligence Engine
              </a>
              <a href="https://georisk.viajeinteligencia.com" className="text-blue-400 hover:text-blue-300">
                GeoRisk - Real-time OSINT risk monitoring
              </a>
              <a href="https://gc.motors.viajeinteligencia.com" className="text-blue-400 hover:text-blue-300">
                GC Motors - Mobility and diagnostics AI
              </a>
              <a href="https://ireadit.viajeinteligencia.com" className="text-blue-400 hover:text-blue-300">
                iReadIt - Tu biblioteca inteligente de viajes
              </a>
            </div>
          </section>
        </div>
      ...
      <div className="flex flex-col items-center justify-center py-6 px-4 bg-gradient-to-r from-blue-600/10 to-purple-600/10 border-y border-white/5">
        <p className="text-white text-sm md:text-base font-medium mb-3 text-center">
          Accede a analisis premium, alertas personalizadas y 107 paises
          <span className="text-blue-400"> 7 dias gratis sin tarjeta</span>
        </p>
