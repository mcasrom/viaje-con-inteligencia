...
const ALL_ROUTES = [
  { id: 'molinos', title: 'Ruta de los Molinos', region: 'La Mancha', color: 'amber', days: '4-5', km: '450', difficulty: 'Fácil', desc: 'Don Quijote vio gigantes. Molinos monumentales, gastronomía manchega.', icon: 'wind', image: 'https://images.unsplash.com/photo-1564053489984-317fa0d8bc2e?w=800&q=80' },
  { id: 'faros', title: 'Ruta de los Faros', region: 'Costa España', color: 'cyan', days: '5-7', km: '2100', difficulty: 'Moderado', desc: 'De Huelva a Gerona. Los faros más emblemáticos.', icon: 'lighthouse', image: 'https://images.unsplash.com/photo-1507003098321-0bfab38fda89?w=800&q=80' },
  { id: 'murcia', title: 'Ruta de Murcia', region: 'Murcia', color: 'emerald', days: '3-4', km: '280', difficulty: 'Fácil', desc: 'Caravaca, Calasparra, Moratalla. Pueblos monumentales.', icon: 'mountain', image: 'https://images.unsplash.com/photo-1539037116267-5dd7691cee47?w=800&q=80' },
  { id: 'rioja', title: 'Ruta del Vino', region: 'La Rioja', color: 'red', days: '3-4', km: '200', difficulty: 'Fácil', desc: 'Bodegas centenarias, viñedos y gastronomía riojana.', icon: 'wine', image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=800&q=80' },
  { id: 'pirineos', title: 'Ruta de Nieve', region: 'Pirineos', color: 'blue', days: '5-7', km: '350', difficulty: 'Alto', desc: 'Estaciones de esquí y montañas.', icon: 'snow', image: 'https://images.unsplash.com/photo-1491553895911-0055eca6402e?w=800&q=80' },
  ...
  { id: 'patrimonio', title: 'Ciudades Patrimonio', region: 'Centro España', color: 'purple', days: '5-6', km: '600', difficulty: 'Fácil', desc: 'Toledo, Ávila, Salamanca. Ciudades patrimonio.', icon: 'building', image: 'https://images.unsplash.com/photo-1547981609-4b6bfe67ca0b?w=800&q=80' },
];
