...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/travel-risk-intelligence`, priority: 0.7, changeFrequency: 'monthly' as const, lastModified: new Date() },
    { url: `${BASE_URL}/osint-para-viajeros`, priority: 0.7, changeFrequency: 'monthly' as const, lastModified: new Date() },
    { url: `${BASE_URL}/geopolitica-y-viajes`, priority: 0.7, changeFrequency: 'monthly' as const, lastModified: new Date() },
