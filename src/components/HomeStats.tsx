...
interface Stats { subscribers: number; alertsToday: number; updatedAgo: string; }
export default function HomeStats() {
  ...
  return (
    <div className="w-full flex items-center justify-center gap-4 md:gap-8 py-3 px-4 text-xs text-slate-400 flex-wrap">
