...
const steps = [
  ...
  },
  {
    ...
    description: 'Consulta el nivel de riesgo de 100+ países con datos actualizados. Incluye índices de paz, salud, desarrollo y alertas en tiempo real.',
        ...
        <div className="p-6">
          ...
          {currentStep === 0 && (
            <div className="space-y-3 mb-6">
              {[
                { icon: <MapPin className="w-4 h-4" />, text: '100+ países con datos de riesgo actualizados' },
