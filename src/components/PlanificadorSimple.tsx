...
export default function PlanificadorSimple() {
  ...
  const handleAnalizar = async () => {
    ...
    // Redireccionar a la página del país destino
    router.push(`/pais/${destino.toLowerCase()}`);
  };
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-6">
      <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 shadow-lg shadow-blue-500/20 border border-blue-400/30">
