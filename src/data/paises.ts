...
requerimientos: [
  ...
  ng: {
    ...
    idioma: 'Inglés',
    moneda: 'Naira (NGN)',
    tipoCambio: '1 EUR ≈ 1650 NGN',
    zonaHoraria: 'UTC+1',
    conduccion: 'derecha',
    poblacion: '220 millones',
    pib: '450 mil millones USD',
    indicadores: { ipc: '18%', indicePrecios: 'Alto' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+234',
    nivelRiesgo: 'medio',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      'Explorar la Abuja moderna',
      'Disfrutar la nightlife de Lagos',
      'Recorrer la Reserva de Jos',
      'Relajarse en las playas de Lagos',
      'Visitar las cascadas de Erin-Ijesha',
      'Descubrir la cultura Yoruba en Ife',
      'Recorrer el Parque Nacional Yankari',
    ],
    queNoHacer: [
      'No viajes al norte sin precaución',
      'No bebas agua del grifo',
      'No muestres riqueza en público',
      'No viajes de noche por carretera',
    ],
  ...
  gh: {
    ...
    idioma: 'Inglés',
    moneda: 'Cedi (GHS)',
    tipoCambio: '1 EUR ≈ 12.5 GHS',
    zonaHoraria: 'UTC+0',
    conduccion: 'derecha',
    poblacion: '33 millones',
    pib: '77 mil millones USD',
    indicadores: { ipc: '8%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+233',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      'Recorrer los Castillos de la Costa Oro',
      'Hacer safari en el canopy de Kakum',
      'Explorar las Lagunas de Volta',
      'Visitar los mercados de Acra',
      'Descubrir la cultura Ashanti en Kumasi',
      'Recorrer la playa de Busua',
      'Visitar la mezquita de Larabanga',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares',
      'No discutas temas políticos',
      'No ignores los avisos de seguridad',
      'No bebas agua del grifo',
    ],
  ...
  et: {
    ...
    tipoCambio: '1 EUR ≈ 55 ETB',
    zonaHoraria: 'UTC+3',
    conduccion: 'derecha',
    poblacion: '120 millones',
    pib: '126 mil millones USD',
    indicadores: { ipc: '20%', indicePrecios: 'Alto' },
    voltaje: '220V / 50Hz',
    prefijoTelefono: '+251',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Marzo 2026',
    contactos: [{ tipo: 'Embajada', nombre: 'Embajada de España en Adís Abeba', direccion: 'Bole Road, Behind Edna Mall', telefono: '+251 116 610 022', email: 'emb.adisabeba@maec.es', horario: 'Lunes a viernes 8:00-16:00' }],
    requerimientos: [{ categoria: 'Documentación', icon: '📄', items: ['Pasaporte 6 meses', 'Visa en arrival', 'Vacuna fiebre amarela si viene de zona riesgo'] }, { categoria: 'Sanitario', icon: '🏥', items: ['Malaria en lowlands', 'Altitude sickness', 'Urgencias: 907'] }, { categoria: 'General', icon: 'ℹ️', items: ['Birr', 'Orthodox Christian', 'Coffee origin'] }],
    queHacer: [
      'Visitar las iglesias de Lalibela',
      'Recorrer las montañas Simien',
      'Ver las cataratas Blue Nile',
      'Explorar el volcán Erta Ale',
      'Descubrir las ruinas de Axum',
      'Recorrer el mercado Merkato de Adís Abeba',
      'Degustar el café etíope tradicional',
    ],
    queNoHacer: [
      'No fotografíes personas sin permiso',
      'No muestres plantas de cannabis',
      'No discutas temas políticos',
      'No bebas agua sin hervir',
    ],
    diarios: [{ nombre: 'The Reporter', url: 'https://thereporter.et' }],
    urlsUtiles: [{ nombre: 'Turismo Etiopía', url: 'https://ethiopiatourism.gov.et' }, { nombre: 'Embajada', url: 'https://www.exteriores.gob.es/embajadas/addisabeba' }],
    bandera: '🇪🇹',
    mapaCoordenadas: [9.145, 40.4897]
  },
  rw: {
    codigo: 'rw',
    nombre: 'Ruanda',
    ...
    tipoCambio: '1 EUR ≈ 1200 RWF',
    zonaHoraria: 'UTC+2',
    conduccion: 'derecha',
    poblacion: '13 millones',
    pib: '11 mil millones USD',
    indicadores: { ipc: '5%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+250',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      'Trekking con gorilas en Volcanoes',
      'Relajarse en el lago Kivu',
      'Explorar el Parque Nacional Nyungwe',
      'Visitar el Memorial Genocidio en Kigali',
      'Recorrer el Parque Nacional Akagera',
      'Descubrir el mercado de Kimironko',
      'Senderismo en las colinas de Thousand Hills',
    ],
    queNoHacer: [
      'No uses bolsas de plástico',
      'No hables del genocidio sin contexto',
      'No ignores las normas ambientales',
      'No fotografíes sin permiso local',
    ],
    ...
    bandera: '🇷🇼',
    mapaCoordenadas: [-1.9403, 29.8739]
  },
  tn: {
    codigo: 'tn',
    nombre: 'Túnez',
    ...
    tipoCambio: '1 EUR ≈ 3.3 TND',
    zonaHoraria: 'UTC+1',
    conduccion: 'derecha',
    poblacion: '12 millones',
    pib: '48 mil millones USD',
    indicadores: { ipc: '7%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+216',
    nivelRiesgo: 'sin-riesgo',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      'Explorar las ruinas de Cartago',
      'Perderse en la Medina de Túnez',
      'Disfrutar de la isla de Djerba',
      'Recorrer el desierto de Chott el Jerid',
      'Visitar las ruinas de Dougga',
      'Descubrir el pueblo azul de Sidi Bou Said',
      'Relajarse en las playas de Hammamet',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares',
      'No critiques al Islam',
      'No ignores las zonas fronterizas',
      'No bebas agua del grifo',
    ],
    ...
    bandera: '🇹🇳',
    mapaCoordenadas: [33.8869, 9.5375]
  },
  sn: {
    codigo: 'sn',
    nombre: 'Senegal',
    ...
    tipoCambio: '1 EUR ≈ 655 XOF',
    zonaHoraria: 'UTC+0',
    conduccion: 'derecha',
    poblacion: '18 millones',
    pib: '27 mil millones USD',
    indicadores: { ipc: '3%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+221',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      ...
      'Explorar el Delta del Saloum',
      'Recorrer la ciudad colonial de Saint-Louis',
      'Relajarse en las playas de Dakar',
      'Descubrir el Lago Rosa',
      'Visitar el Museo IFAN de Dakar',
      'Degustar el thieboudienne tradicional',
    ],
    queNoHacer: [
      'No fotografíes sin permiso',
      'No ignores las normas aduaneras',
      'No discutas temas políticos',
    ...
    bandera: '🇸🇳',
    mapaCoordenadas: [14.4974, -14.4524]
  },
  bw: {
    codigo: 'bw',
    nombre: 'Botsuana',
    ...
    queHacer: [
      ...
      'Visitar el Parque Nacional Chobe',
      'Explorar el desierto del Kalahari',
      'Recorrer la Reserva Moremi',
      'Ver las salinas de Makgadikgadi',
      'Senderismo en las colinas de Tsodilo',
      'Observar elefantes en Savuti',
    ],
    queNoHacer: [
      'No ignores las normas del parque',
      'No te acerques a la fauna salvaje',
      'No ignores los consejos de los guías',
      'No salgas del vehículo en zonas peligrosas',
    ],
    ...
    bandera: '🇧🇼',
    mapaCoordenadas: [-22.3285, 24.6849]
  },
  mu: {
    codigo: 'mu',
    nombre: 'Mauricio',
    ...
    queHacer: [
      'Relajarse en las playas de arena blanca',
      'Visitar las Seven Colored Earths',
      'Ver la cascada Chamarel',
      'Bucear en Blue Bay Marine Park',
      'Explorar el Jardín Botánico de Pamplemousses',
      'Recorrer el mercado de Port Louis',
      'Navegar por la Isla aux Cerfs',
    ],
    queNoHacer: [
      'No uses productos que dañen los corales',
      'No ignores la protección del medio ambiente',
      'No recolectes coral',
    ...
    bandera: '🇲🇺',
    mapaCoordenadas: [-20.3484, 57.5522]
  },
  bd: {
    codigo: 'bd',
    nombre: 'Bangladesh',
    ...
    tipoCambio: '1 EUR ≈ 120 BDT',
    zonaHoraria: 'UTC+6',
    conduccion: 'izquierda',
    poblacion: '170 millones',
    pib: '400 mil millones USD',
    indicadores: { ipc: '6%', indicePrecios: 'Medio' },
    voltaje: '220V / 50Hz',
    prefijoTelefono: '+880',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      'Explorar los Sundarbans',
      'Visitar el templo Buddha en Paharpur',
      'Relajarse en la playa de Cox\'s Bazar',
      'Recorrer la Daca antigua',
      'Descubrir el río Meghna en barco',
      'Visitar las ruinas de Somapura Mahavihara',
      'Degustar la gastronomía bengalí',
    ],
    queNoHacer: [
      'No fotografíes mujeres sin permiso',
      'No bebas agua del grifo',
      'No ignores las zonas de inundación',
      'No consumas carne no halal',
    ],
    ...
    bandera: '🇧🇩',
    mapaCoordenadas: [23.685, 90.3563]
  },
  pk: {
    codigo: 'pk',
    nombre: 'Pakistán',
    ...
    tipoCambio: '1 EUR ≈ 310 PKR',
    zonaHoraria: 'UTC+5',
    conduccion: 'izquierda',
    poblacion: '230 millones',
    pib: '340 mil millones USD',
    indicadores: { ipc: '10%', indicePrecios: 'Alto' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+92',
    nivelRiesgo: 'medio',
    ultimoInforme: 'Marzo 2026',
    ...
    queHacer: [
      ...
      'Explorar la cultura de Lahore',
      'Relajarse en las playas de Karachi',
      'Visitar las ruinas de Mohenjo-daro',
      'Recorrer el Valle de Hunza',
      'Descubrir la mezquita Faisal en Islamabad',
      'Senderismo en el Parque Nacional Deosai',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares',
      'No ignores los avisos de seguridad',
      'No bebas alcohol en público',
      'No viajes a zonas tribales sin permiso',
    ],
    ...
    bandera: '🇵🇰',
    mapaCoordenadas: [30.3753, 69.3451]
  },
  fj: {
    codigo: 'fj',
    nombre: 'Fiyi',
    ...
    tipoCambio: '1 EUR ≈ 2.4 FJD',
    zonaHoraria: 'UTC+12',
    conduccion: 'izquierda',
    poblacion: '900,000',
    pib: '5 mil millones USD',
    indicadores: { ipc: '4%', indicePrecios: 'Medio' },
    voltaje: '240V / 50Hz',
    prefijoTelefono: '+679',
    nivelRiesgo: 'sin-riesgo',
    ...
    queHacer: [
      'Relajarse en las playas de Nadi',
      'Explorar las Islas Yasawa',
      'Visitar los mercados de Suva',
      'Bucear en la Coral Coast',
      'Descubrir las cascadas de Sigatoka',
      'Participar en una ceremonia kava',
      'Senderismo en Bouma National Park',
    ],
    queNoHacer: [
      'No uses productos que dañen los arrecifes',
      'No ignores la temporada de ciclones',
      'No ignores las normas locales del pueblo',
      'No subestimes el sol tropical',
    ],
    ...
    bandera: '🇫🇯',
    mapaCoordenadas: [-17.7134, 178.065]
  },
  pg: {
    codigo: 'pg',
    ...
    queHacer: [
      'Trekking en las Highlands',
      'Recorrer el Kokoda Track',
      'Explorar los fiordos de Tufi',
      'Bucear en Port Moresby',
      'Visitar el festival cultural de Goroka',
      'Navegar por el río Sepik',
      'Descubrir las tribus de Enga',
    ],
    queNoHacer: [
      'No ignores las tierras tribales',
      'No fotografíes sin permiso',
      'No ignores los avisos de criminalidad',
      'No viajes solo de noche',
    ],
    ...
    bandera: '🇵🇬',
    mapaCoordenadas: [-6.315, 143.9555]
  },
  ws: {
    codigo: 'ws',
    nombre: 'Samoa',
    ...
    idioma: 'Samoano',
    moneda: 'Tala (WST)',
    tipoCambio: '1 EUR ≈ 2.9 WST',
    zonaHoraria: 'UTC+13',
    conduccion: 'izquierda',
    poblacion: '200,000',
    pib: '800 millones USD',
    indicadores: { ipc: '3%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+685',
    nivelRiesgo: 'sin-riesgo',
    ...
    queHacer: [
      'Nadar en el To Sua ocean trench',
      'Ver las rocas deslizantes de Papaseea',
      'Asistir a una fiesta faiai',
      'Relajarse en las playas de Upolu',
      'Explorar la selva tropical de O Le Pupu-Pu',
      'Visitar las cascadas de Afu Aau',
      'Descubrir la cultura samoana en Apia',
    ],
    queNoHacer: [
      'No ignores el sistema matai local',
      'No faltes al respeto a los ancianos',
      'No uses ropa inapropiada en aldeas',
      'No ignores las normas de domingo sagrado',
    ],
    ...
    bandera: '🇼🇸',
    mapaCoordenadas: [-13.759, -172.1046]
  },
  gt: {
    codigo: 'gt',
    nombre: 'Guatemala',
    ...
    queHacer: [
      'Explorar las ruinas mayas de Tikal',
      'Recorrer la ciudad colonial de Antigua Guatemala',
      'Visitar el lago Atitlán',
      'Descubrir Semuc Champey',
      'Recorrer el mercado de Chichicastenango',
      'Senderismo en el volcán Pacaya',
      'Descubrir el Parque Nacional Río Dulce',
    ],
    queNoHacer: [
      'No fotografíes sin permiso',
      'No ignores las zonas de riesgo',
      'No consumas drogas',
      'No viajes de noche por carretera',
    ],
    ...
    bandera: '🇬🇹',
    mapaCoordenadas: [15.7835, -90.2308]
  },
  jm: {
    codigo: 'jm',
    nombre: 'Jamaica',
    ...
    tipoCambio: '1 EUR ≈ 165 JMD',
    zonaHoraria: 'UTC-5',
    conduccion: 'izquierda',
    poblacion: '3 millones',
    pib: '15 mil millones USD',
    indicadores: { ipc: '5%', indicePrecios: 'Medio' },
    voltaje: '110V / 50Hz',
    prefijoTelefono: '+1',
    nivelRiesgo: 'bajo',
    ...
    queHacer: [
      'Relajarse en Seven Mile Beach',
      'Visitar el Museo Bob Marley en Kingston',
      'Trekking en Dunn River Falls',
      'Disfrutar los atardeceres de Negril',
      'Visitar las cascadas de YS Falls',
      'Descubrir la Blue Mountain',
      'Rafting en el río Martha Brae',
    ],
    queNoHacer: [
      'No consumas drogas',
      'No ignores las zonas de riesgo en Kingston',
      'No fotografíes sin consentimiento',
      'No viajes solo de noche',
    ],
    ...
    bandera: '🇯🇲',
    mapaCoordenadas: [18.1096, -77.2975]
  },
  tt: {
    codigo: 'tt',
    ...
    continente: 'América',
    idioma: 'Inglés',
    moneda: 'Dólar trinitense (TTD)',
    tipoCambio: '1 EUR ≈ 7.2 TTD',
    zonaHoraria: 'UTC-4',
    conduccion: 'izquierda',
    poblacion: '1.4 millones',
    pib: '24 mil millones USD',
    indicadores: { ipc: '3%', indicePrecios: 'Medio' },
    voltaje: '115V / 60Hz',
    prefijoTelefono: '+1',
    nivelRiesgo: 'sin-riesgo',
    ...
    queHacer: [
      'Disfrutar del Carnival de Trinidad',
      'Relajarse en las playas de Tobago',
      'Visitar el Pitch Lake',
      'Explorar el Asa Wright Nature Centre',
      'Descubrir la gastronomía criolla',
      'Bucear en el Tobago Cays',
      'Recorrer la selva tropical de Main Ridge',
    ],
    queNoHacer: [
      'No consumas drogas',
      'No ignores las normas de seguridad en playas',
      'No fotografíes sin permiso',
      'No subestimes las corrientes marinas',
    ],
...
si: {
  ...
  uy: {
    ...
    queHacer: [
      'Visitar Punta del Este',
      'Explorar Colonia del Sacramento',
      'Degustar asado uruguayo',
      'Recorrer Montevideo y su Rambla',
      'Conocer la bodega de vino Tannat',
      'Surf en La Paloma',
      'Carnaval de Montevideo',
    ],
    queNoHacer: [
      'No conducir después de beber',
      'No ignorar normas de tráfico',
      'No cambiar dinero en la calle',
      'No dejar pertenencias sin vigilancia en playas',
    ],
  ...
  py: {
    ...
    queHacer: [
      ...
      'Explorar las Misiones Jesuíticas',
      'Conocer Asunción y su casco histórico',
      'Recorrer el Chaco paraguayo',
      'Degustar chipá y sopa paraguaya',
      'Comprar artesanía en Luque',
      'Aventura en el río Paraguay',
    ],
    queNoHacer: [
      'No manejar de noche',
      'No mostrar objetos valiosos',
      'No viajar a zonas fronterizas sin precaución',
      'No beber agua del grifo',
    ],
  ...
  bo: {
    ...
    queHacer: [
      ...
      'Recorrer la ciudad de Potosí',
      'Descubrir Sucre, la ciudad blanca',
      'Senderismo en el Parque Nacional Madidi',
      'Degustar salteñas y anticuchos',
      'Bajada en bicicleta al Camino de los Yungas',
    ],
    queNoHacer: [
      'No fotografiar zonas militares',
      'No comprar especies protegidas',
      'No subestimar el mal de altura',
      'No beber agua del grifo',
    ],
  ...
  gl: {
    ...
    queHacer: [
      ...
      'Safari de fauna ártica',
      'Visitar Ilulissat y sus icebergs',
      'Recorrer la capital Nuuk',
      'Trekking en el Parque Nacional del Nordeste',
      'Conocer la cultura inuit local',
    ],
    queNoHacer: [
      'No alejarse de poblaciones en invierno',
      'No alimentar a la fauna',
      'No alterar el ecosistema',
      'No ignores las condiciones climáticas extremas',
    ],
  ...
  kz: {
    ...
    idioma: 'Kazajo, Ruso',
    moneda: 'Tenge (KZT)',
    tipoCambio: '1 EUR ≈ 450 KZT',
    zonaHoraria: 'UTC+5 a UTC+6',
    conduccion: 'derecha',
    poblacion: '19 millones',
    pib: '220 mil millones USD',
    indicadores: { ipc: '7.5%', indicePrecios: 'Medio' },
    voltaje: '220V / 50Hz',
    prefijoTelefono: '+7',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Abril 2026',
    ...
    requerimientos: [],
    queHacer: [
      'Explorar el Cañón de Charyn',
      'Visitar el cosmódromo de Baikonur',
      'Esquiar en Shymbulak (Almaty)',
      'Recorrer el lago Kolsai y Kaindy',
      'Descubrir la arquitectura futurista de Astana',
      'Senderismo en el Parque Nacional Altyn-Emel',
      'Visitar el Mercado Verde de Almaty',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares o gubernamentales',
      'No bebas agua del grifo',
      'No viajes a zonas fronterizas sin permiso',
      'No ignores el registro migratorio obligatorio',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇰🇿',
    mapaCoordenadas: [48.0196, 66.9237]
  },
  uz: {
    codigo: 'uz',
    nombre: 'Uzbekistán',
    ...
    tipoCambio: '1 EUR ≈ 12,000 UZS',
    zonaHoraria: 'UTC+5',
    conduccion: 'derecha',
    poblacion: '36 millones',
    pib: '80 mil millones USD',
    indicadores: { ipc: '9%', indicePrecios: 'Medio' },
    voltaje: '220V / 50Hz',
    prefijoTelefono: '+998',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Abril 2026',
    ...
    requerimientos: [],
    queHacer: [
      'Explorar la Plaza Registan en Samarcanda',
      'Recorrer la ciudad antigua de Bujará',
      'Visitar Itchan Kala en Khiva',
      'Descubrir el mercado Chorsu en Tashkent',
      'Ver las pinturas rupestres de Sarmishsay',
      'Degustar plov uzbeko en un chaikhana',
      'Recorrer el Valle de Ferganá',
    ],
    queNoHacer: [
      'No fotografíes edificios gubernamentales o militares',
      'No cambies dinero en la calle',
      'No ignores las normas de vestimenta en lugares religiosos',
      'No bebas agua del grifo',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇺🇿',
    mapaCoordenadas: [41.2995, 69.2401]
  },
  kg: {
    codigo: 'kg',
    nombre: 'Kirguistán',
    ...
    tipoCambio: '1 EUR ≈ 90 KGS',
    zonaHoraria: 'UTC+6',
    conduccion: 'derecha',
    poblacion: '7 millones',
    pib: '14 mil millones USD',
    indicadores: { ipc: '8%', indicePrecios: 'Bajo' },
    voltaje: '220V / 50Hz',
    prefijoTelefono: '+996',
    nivelRiesgo: 'bajo',
    ultimoInforme: 'Abril 2026',
    ...
    requerimientos: [],
    queHacer: [
      'Trekking por el lago Issyk-Kul',
      'Alojarse en yurts tradicionales',
      'Explorar las montañas Tian Shan',
      'Recorrer el desfiladero de Ala Archa',
      'Visitar el mercado de Osh',
      'Senderismo en el lago Song-Kul',
      'Cabalgar por los pastos de Jety-Oguz',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares o fronterizas',
      'No bebas agua sin hervir',
      'No ignores las condiciones climáticas en montaña',
      'No cruces fronteras sin visado correcto',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇰🇬',
    mapaCoordenadas: [42.8746, 74.5898]
  },
  tj: {
    codigo: 'tj',
    nombre: 'Tayikistán',
    ...
    requerimientos: [],
    queHacer: [
      'Recorrer la carretera del Pamir',
      'Visitar el lago Iskanderkul',
      'Explorar las ruinas de Sarazm',
      'Senderismo en el Parque Nacional Tajik',
      'Descubrir el mercado Panjshanbe en Khujand',
      'Ver las montañas de las Siete hermanas',
      'Conocer la cultura pamiri en Khorog',
    ],
    queNoHacer: [
      'No viajes cerca de la frontera con Afganistán',
      'No fotografíes infraestructura militar',
      'No ignores los permisos GBAO para el Pamir',
      'No bebas agua sin filtrar',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇹🇯',
    mapaCoordenadas: [38.5598, 68.7738]
  },
  mn: {
    codigo: 'mn',
    nombre: 'Mongolia',
    ...
    requerimientos: [],
    queHacer: [
      'Cabalgata por la estepa mongola',
      'Visitar el monasterio de Erdene Zuu',
      'Explorar el desierto de Gobi',
      'Convivir con familias nómadas en ger',
      'Ver las dunas de Khongoryn Els',
      'Trekking en el Parque Nacional Gorkhi-Terelj',
      'Asistir al festival Naadam (julio)',
    ],
    queNoHacer: [
      'No subestimes las temperaturas nocturnas',
      'No bebas agua sin hervir o filtrar',
      'No ignores las señales en zonas minadas',
      'No cruces ríos sin guía local',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇲🇳',
    mapaCoordenadas: [47.9184, 106.9177]
  },
  am: {
    codigo: 'am',
    nombre: 'Armenia',
    ...
    queHacer: [
      ...
      'Explorar el templo Garni',
      'Recorrer el lago Sevan',
      'Descubrir Ereván y sus museos',
      'Visitar el monumento al Genocidio Tsitsernakaberd',
      'Senderismo en el cañón de Garni',
      'Cata de vinos en la bodega Areni',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares',
      'No cruces la frontera con Azerbaiyán',
      'No ignores las zonas minadas en regiones fronterizas',
      'No bebas agua del grifo',
    ],
    diarios: [],
    urlsUtiles: [],
    bandera: '🇦🇲',
    mapaCoordenadas: [40.0691, 45.0382]
  },
  az: {
    codigo: 'az',
    nombre: 'Azerbaiyán',
    ...
    requerimientos: [],
    queHacer: [
      'Explorar la Ciudad Vieja de Bakú (Icherisheher)',
      'Ver los volcanes de lodo de Gobustan',
      'Visitar el Palacio de los Shirvanshahs',
      'Recorrer el Boulevard de Bakú',
      'Descubrir el arte moderno en el Centro Heydar Aliyev',
      'Visitar la ciudad de Sheki y su palacio',
      'Ver las llamas de Yanar Dag',
    ],
    queNoHacer: [
      'No fotografíes instalaciones militares o petroleras',
      'No cruces la frontera con Armenia',
      'No ignores las restricciones en Nagorno-Karabaj',
      'No bebas agua del grifo',
    ],
    diarios: [],
    urlsUtiles: [],
  ...
  sd: {
    ...
    queHacer: [
      ...
      'Confluencia del Nilo Azul y Blanco en Jartum',
      'Museo Nacional de Sudán',
      'Mercados tradicionales de Omdurman',
      'Mezquita Al-Mahdi en Omdurman',
      'Ruinas del templo de Amón en Naqa',
      'Pueblo de Suakin (antiguo puerto otomano)',
      'Monte Barkal y las pirámides de Nuri',
      'Artesanía textil de Kassala',
    ],
    queNoHacer: [
  ...
  af: {
    ...
    queHacer: [
      'Valle de Bamiyán y sus acantilados',
      'Museo Nacional de Kabul',
      'Jardines de Babur',
      'Mercado de Kabul',
      'Lago Band-e-Amir (patrimonio natural)',
      'Antigua ciudad de Herat y su mezquita',
      'Estupa de Shotorak en Ghazni',
      'Bosques de Paghman cerca de Kabul',
    ],
    queNoHacer: [
  ...
  ye: {
    ...
    queHacer: [
      'Arquitectura tradicional de Saná',
      'Puerto histórico de Adén',
      'Mercados de spices en Taiz',
      'Ruinas de Marib',
      'Zabid (ciudad histórica UNESCO)',
      'Antigua ciudad amurallada de Shibam',
      'Playas de Socotra (si situación lo permite)',
      'Dar al-Hajar (Palacio de Roca)',
    ],
    queNoHacer: [
  ...
  sy: {
    ...
    queHacer: [
      ...
      'Catedral de San Pablo (primer templo cristiano)',
      'Museo Nacional de Alepo (si accesible)',
  ...
  ly: {
    ...
    queHacer: [
      'Ruinas romanas de Leptis Magna',
      'Medina de Trípoli',
      'Ruinas de Cirene',
      'Desierto del Sahara libio',
      'Arquitectura italiana de Bengasi',
      'Museo Jamahiriya en Trípoli',
      'Ruinas fenicias de Sabratha',
      'Oasis de Gadamés (ciudad oasis UNESCO)',
    ],
    queNoHacer: [
  ...
  ht: {
    ...
    queHacer: [
      'Ciudadela Laferrière (UNESCO)',
      'Palacio Sans-Souci en Milot',
      'Playas de Labadee',
      'Centro artístico de Jacmel',
      'Cascadas de Bassin Bleu',
      'Museo del Panthéon Haitiano en Puerto Príncipe',
      'Isla de La Gonâve',
      'Mercado de Artibonito y su artesanía',
    ],
    queNoHacer: [
