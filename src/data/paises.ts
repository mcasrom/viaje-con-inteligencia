...
requerimientos: [
  ...
  et: {
    ...
    queHacer: ['Rocas de Erta Ale', 'Iglesias de Lalibela', 'Montañas Simien', 'Cataratas Blue Nile'],
    queNoHacer: ['No fotgrafíes personas sin permiso', 'No muestres plantas de cannabis', 'No discutas política'],
  ...
  no: {
    ...
    tipoCambio: '1 EUR ≈ 12 NOK',
    zonaHoraria: 'UTC+1',
    conduccion: 'derecha',
    poblacion: '5.4 millones',
    pib: '640 mil millones USD',
    indicadores: { ipc: '4%', indicePrecios: 'Muy alto' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+47',
    nivelRiesgo: 'sin-riesgo',
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Oslo', direccion: 'Haakon VIIs gate 1, Oslo', telefono: '+47 220 690 00', email: 'emb.oslo@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Oslo', direccion: 'Haakon VIIs gate 1, Oslo', telefono: '+47 220 690 00', email: 'emb.oslo@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Oslo' },
    bandera: '🇳🇴',
    mapaCoordenadas: [59.9139, 10.7522]
  },
  se: {
    codigo: 'se',
    nombre: 'Suecia',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Estocolmo', direccion: 'Adolf Fredriks kyrkogata 12, Estocolmo', telefono: '+46 8 240 800', email: 'emb.estocolmo@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    diplomacia: { horario: 'Consulado: L-V 10-13' },
    embajada: { nombre: 'Embajada de España en Estocolmo', direccion: 'Adolf Fredriks kyrkogata 12, Estocolmo', telefono: '+46 8 240 800', email: 'emb.estocolmo@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Estocolmo' },
    bandera: '🇸🇪',
    mapaCoordenadas: [59.3293, 18.0686]
  },
  dk: {
    codigo: 'dk',
    nombre: 'Dinamarca',
    ...
    pib: '400 mil millones USD',
    indicadores: { ipc: '2%', indicePrecios: 'Alto' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+45',
    nivelRiesgo: 'sin-riesgo',
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Copenhague', direccion: 'Kongevej 15, Copenhagen', telefono: '+45 3314 2211', email: 'emb.copenhague@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Copenhague', direccion: 'Kongevej 15, Copenhagen', telefono: '+45 3314 2211', email: 'emb.copenhague@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Copenhague' },
    bandera: '🇩🇰',
    mapaCoordenadas: [55.6761, 12.5683]
  },
  fi: {
    codigo: 'fi',
    nombre: 'Finlandia',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Helsinki', direccion: 'Mannerheimintie 15, Helsinki', telefono: '+358 9 687 7060', email: 'emb.helsinki@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Helsinki', direccion: 'Mannerheimintie 15, Helsinki', telefono: '+358 9 687 7060', email: 'emb.helsinki@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Helsinki' },
    bandera: '🇫🇮',
    mapaCoordenadas: [60.1699, 24.9384]
  },
  ee: {
    codigo: 'ee',
    nombre: 'Estonia',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Tallin', direccion: 'Kohtu 4, Tallin', telefono: '+372 630 2700', email: 'emb.tallin@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Tallin', direccion: 'Kohtu 4, Tallin', telefono: '+372 630 2700', email: 'emb.tallin@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Tallin' },
    bandera: '🇪🇪',
    mapaCoordenadas: [59.437, 24.7536]
  },
  lv: {
    codigo: 'lv',
    nombre: 'Letonia',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Riga', direccion: 'Elizabetes iela 11, Riga', telefone: '+371 673 23120', email: 'emb.riga@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Riga', direccion: 'Elizabetes iela 11, Riga', telefono: '+371 673 23120', email: 'emb.riga@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Riga' },
    bandera: '🇱🇻',
    mapaCoordenadas: [56.9496, 24.1052]
  },
  lt: {
    codigo: 'lt',
    nombre: 'Lituania',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Vilna', direccion: 'Upes 7, Vilna', telefono: '+370 526 284 45', email: 'emb.vilna@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Vilna', direccion: 'Upes 7, Vilna', telefono: '+370 526 284 45', email: 'emb.vilna@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Vilna' },
    bandera: '🇱🇹',
    mapaCoordenadas: [54.6872, 25.2797]
  },
  hr: {
    codigo: 'hr',
    nombre: 'Croacia',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Zagreb', direccion: 'Pantovcak 111, Zagreb', telefono: '+385 1 482 1000', email: 'emb.zagreb@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Zagreb', direccion: 'Pantovcak 111, Zagreb', telefono: '+385 1 482 1000', email: 'emb.zagreb@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Zagreb' },
    bandera: '🇭🇷',
    mapaCoordenadas: [45.815, 15.9819]
  },
  si: {
    codigo: 'si',
    nombre: 'Eslovenia',
    capital: 'Liubliana',
    continente: 'Europa',
    idioma: 'Esloveno, Inglés, Alemán',
    moneda: 'Euro (EUR)',
    tipoCambio: '1 EUR',
    zonaHoraria: 'UTC+1',
    conduccion: 'derecha',
    poblacion: '2.1 millones',
    pib: '58 mil millones USD',
    indicadores: { ipc: '3%', indicePrecios: 'Medio' },
    voltaje: '230V / 50Hz',
    prefijoTelefono: '+386',
    nivelRiesgo: 'sin-riesgo',
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Liubliana', direccion: 'Trubarjeva 44, Liubliana', telefono: '+386 1 426 2030', email: 'emb.liubliana@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Liubliana', direccion: 'Trubarjeva 44, Liubliana', telefono: '+386 1 426 2030', email: 'emb.liubliana@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Liubliana' },
    bandera: '🇸🇮',
    mapaCoordenadas: [46.0569, 14.5058]
  },
  sk: {
    codigo: 'sk',
    nombre: 'Eslovaquia',
    capital: 'Bratislava',
    continente: 'Europa',
    idioma: 'Eslovaco, Inglés, Húngaro',
    moneda: 'Euro (EUR)',
    tipoCambio: '1 EUR',
    zonaHoraria: 'UTC+1',
    conduccion: 'derecha',
    ...
    ultimoInforme: 'Abril 2026',
    contactos: [
      { tipo: 'Embajada', nombre: 'Embajada de España en Bratislava', direccion: 'Hodzova 6, Bratislava', telefono: '+421 2 544 186 38', email: 'emb.bratislava@maec.es', horario: 'L-V 9-14' }
    ],
    requisitos: [
      { categoria: 'Visado', icon: '📄', items: ['Ciudadanos españoles: hasta 90 días sin visado'] }
    ],
    embajada: { nombre: 'Embajada de España en Bratislava', direccion: 'Hodzova 6, Bratislava', telefono: '+421 2 544 186 38', email: 'emb.bratislava@maec.es', url: 'https://www.exteriores.gob.es/Embajadas/Bratislava' },
    bandera: '🇸🇰',
    mapaCoordenadas: [48.1486, 17.1077]
  }
};
