...
function extractCountryCode(text: string): string | null {
  const countryMap: Record<string, string> = {
    ...
    'mexico': 'mx', 'cancun': 'mx',
    'brazil': 'br', 'rio': 'br', 'brasilia': 'br',
    'india': 'in', 'delhi': 'in', 'new delhi': 'in', 'mumbai': 'in',
    ...
    'pakistan': 'pk', 'islamabad': 'pk', 'karachi': 'pk',
    ...
    'taiwan': 'tw', 'taipei': 'tw',
    'australia': 'au', 'sydney': 'au', 'melbourne': 'au', 'canberra': 'au',
    'new zealand': 'nz', 'auckland': 'nz', 'wellington': 'nz',
    'netherlands': 'nl', 'amsterdam': 'nl',
    'belgium': 'be', 'brussels': 'be',
    'switzerland': 'ch', 'zurich': 'ch', 'geneva': 'ch', 'berne': 'ch',
    ...
    'mali': 'ml', 'bamako': 'ml',
    'niger': 'ne', 'niamey': 'ne',
    'chad': 'td', "n'djamena": 'td',
    'somalia': 'so', 'mogadishu': 'so', 'somaliland': 'so',
    'south sudan': 'ss', 'juba': 'ss',
    'zambia': 'zm', 'lusaka': 'zm',
